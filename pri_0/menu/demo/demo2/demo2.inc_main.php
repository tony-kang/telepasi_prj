...
$_editDb = $_dbEditForm
    ...
    ->puType(NUMBER_FIELD)
    ->puParaName('gPara')
    ->listViewer('___tableListDemo2')
    ->breadcrumbs(['caption'=>'데모','url'=>''],['caption'=>'데모(2)','url'=>''])
    ->make();
//___print($_editDb);
...
//엑셀저장 버턴이 필요한 경우
//$_excelDialog = ___excelDialog('id_saveExcel',EF_MAKE_EXCEL,'X020');
...
$sFieldList->newField('input','sKey1','데이타',90)->add();
