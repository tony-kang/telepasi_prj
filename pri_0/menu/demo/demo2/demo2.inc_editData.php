...
// Row 1
$editRow->newColumn()->size('col-2')->dbTable(TEXT_FIELD,'data_1')->type(ET_INPUT)->label('테스트항목')->validator('테스트항목을 2자이상 입력해 주세요.','\'__V__\'.length > 1')->required(true)->note('일반입력(필수)')->addCol();
