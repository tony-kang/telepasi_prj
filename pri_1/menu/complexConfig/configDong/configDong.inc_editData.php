...
$editRow->newColumn()->size('col-2')->dbTable(NUMBER_FIELD,'hoCnt')->type(ET_NUMBER)->label('층당 세대수')->minMax(1,100)->addCol();
$editRow->newColumn()->size('col-3')->dbTable(TEXT_FIELD,'hoFormat')->type(ET_INPUT)->label('호수 표시규격')->default('([FLOOR]*100) + [HO]')->addCol();
